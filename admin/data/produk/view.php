            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12">
                        ...
                        <p class="text-muted">
                            Produk ini termasuk ke jenis produk
                            <?= $datas['jenis_produk'] ?>
                        </p>
                        <div class="col-12 col-md-12 col-lg-12">
                            <div class="row">
                                <div class="col-12 col-sm-4">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            ...
                                            <span
                                                class="info-box-number text-center text-muted mb-0"><?= $datas['kode'] ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            <span class="info-box-text text-center text-muted">harga Produk</span>
                                            <span class="info-box-number text-center text-muted mb-0">Rp.
                                                <?= number_format($datas['harga'], 0, ',', '.') ?>,-</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <div class="info-box bg-light">
                                        <div class="info-box-content">
                                            ...
                                            <span
                                                class="info-box-number text-center text-muted mb-0"><?= $datas['stok'] ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
